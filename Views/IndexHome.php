<!--To format/align this code I ued HTML formatter in google-->
<!--To reduce the lines of code I used Tailwind CSS classes-->

<!DOCTYPE html>
<html lang="en" class="h-full bg-gray-100">
<head>
    <meta charset="UTF-8">
    <title>Dynamic DB</title>
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
            <form action="/addTable" method="post">
                <button class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800" type="submit">Add Table</button>
            </form>
        </ul>
        <ul class="space-y-2 font-medium">
